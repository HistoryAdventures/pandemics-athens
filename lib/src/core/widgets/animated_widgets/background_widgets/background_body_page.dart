...
class BackgroundBodyPage extends StatefulWidget {
  const BackgroundBodyPage();

  @override
  _BackgroundBodyPageState createState() => _BackgroundBodyPageState();
}

class _BackgroundBodyPageState extends State<BackgroundBodyPage>
            ...
            return Stack(
              children: [
                ...
                AnimatedVirusBodies(
                  ...
                  size: Size(
                      constraints.maxWidth * 0.8, constraints.maxHeight * 0.85),
                  targetOffset: Offset(-offset.dx * 0.02, -offset.dy * 0.01),
                ),
                AnimatedVirusBodies(
                ...
                AnimatedVirusBodies(
                  bottom: 0,
                  right: constraints.maxHeight * 0.4,
                ...
                AnimatedVirusBodies(
                  ...
                  alignment: Alignment.centerRight,
                  path: AssetsPath.animatedBack3Vbody1,
                  size: Size(constraints.maxWidth * 0.85,
