...
import 'package:history_of_adventures/src/features/character/presentation/bloc/character_bloc.dart';
...
class ChaaracrterPage extends StatefulWidget {
  const ChaaracrterPage({Key? key}) : super(key: key);

  @override
  _ChaaracrterPageState createState() => _ChaaracrterPageState();
}

class _ChaaracrterPageState extends State<ChaaracrterPage> {
      ...
      child: BlocBuilder(
        ...
        builder: (context, state) {
          if (state is CharacterInitial) {
            return buildInit();
          } else if (state is CharacterPressed) {
            return buildBody(state.photoHero);
          }
          return Container();
        },
      ),
  ...
  Widget buildBody(PhotoHero photoHero) {
