                                    ...
                                    AuthorWidget(
                                      ...
                                      urlModeles: [
                                        ...
                                        UrlLuncherModel(
                                            ...
                                            title:
                                                'Cultural depictions of Alcibiades (Socrates Tears Alcibiades from the Embrace of Sensual Pleasure)'),
                                        UrlLuncherModel(
                                            url:
                                                'https://en.wikipedia.org/wiki/Ancient_Greek_coinage#/media/File:SNGCop_039.jpg',
                                            title:
                                                'Ancient Greek coinage (A silver tetradrachm from Athens)'),
                                        UrlLuncherModel(
                                            url:
                                        ...
                                        UrlLuncherModel(
                                            ...
                                            title:
                                                'Athena Parthenos (A reconstruction of the Athena Parthenon statue of Phidias)'),
                                        UrlLuncherModel(
                                            url:
                                                'https://en.wikipedia.org/wiki/The_Trojan_Women#/media/File:Astianax.jpg',
                                            title:
                                                'The Trojan Women (An engraving showing the Odysseus throwing Astynax)'),
                                        UrlLuncherModel(
                                            url:
                                        ...
                                        UrlLuncherModel(
                                            ...
                                            title:
                                                'An engraving of Hippocrates as imagined (Hippocrates rubens)'),
                                        UrlLuncherModel(
                                            url:
                                            ...
                                            title:
                                                'Patients sleeping in the temple of Aesculapius at Epidaurus (Asclepeion)'),
                                        UrlLuncherModel(
                                            url:
                                            ...
                                            title:
                                                'A fragment of the Hippocratic oath (Hippocratic Oath)'),
                                        UrlLuncherModel(
                                            url:
                                                'https://en.wikipedia.org/wiki/File:Alcibades_being_taught_by_Socrates,_Fran%C3%A7ois-Andr%C3%A9_Vincent.jpg',
                                            title:
                                                'Alcibiades receiving the lessons of Socrates (Alcibades being taught by Socrates)'),
                                        UrlLuncherModel(
                                            url:
                                                'https://en.wikipedia.org/wiki/File:Lysander_outside_the_walls_of_Athens_19th_century_lithograph.jpg',
                                            title:
                                                'Lysander overseeing the demolition of Athens’ defensive walls (Lysander outside the walls of Athens)'),
                                      ],
                                    ),
                                  ],
                                ),
